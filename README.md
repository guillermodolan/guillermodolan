...
Soy un profesional apasionado por la **automatización de procesos** y la **inteligencia de datos**. A punto de graduarme en la **UTN FRRo** (ubicada en Rosario, Santa Fé, Argentina), combino la ingeniería de software con herramientas No-Code/Low-Code para crear soluciones eficientes y escalables para empresas.

🔭 **Actualmente:** Trabajando en automatización de procesos para PyMEs y finalizando mi Ingeniería.  
...
* ✅ **Agile & Teamwork:** Experiencia con metodologías ágiles, Trello y ClickUp.
